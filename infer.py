...
HOME_PATH = "model_output_or_others/"
...
#averaged ckpt path
ckpt_path = 'model_output_or_others/train/averaged.ckpt-0'
...
data_path = 'translation/dataset/roa_dosage/OTHERS_OTHERS/'
...
for rx in tqdm(sig_data.Standardized_SIG.tolist()):
    out = translate(rx)
    ml_prediction.append(out['model_output'])
...
sig_data.to_csv('OR_OTHERS_8_3.csv', index=False)
